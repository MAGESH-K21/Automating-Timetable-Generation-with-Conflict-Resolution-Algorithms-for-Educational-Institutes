...
<html>
<head>
  <title>Sairam Time Table Master</title>
...
<body style="min-width: 1348px">
  <div id="header">
    ...
    <div id="header_text">Sairam Time Table Master</div>
  </div>
    ...
    <div class="tableContainer">
      ...
      <div id="backup">
        ...
        <form method="get" action="backup.php" class="submit" style="font-weight: bold">
          ...
          <span style="color:#555;font-size: 15px">Backup:</span> download a snapshot of the database that can be restored later :&nbsp;
